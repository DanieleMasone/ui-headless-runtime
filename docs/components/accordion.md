...
Single, multiple, and dynamic-registration examples are executed from the component-specific [`accordion.ts` example module](https://github.com/DanieleMasone/ui-headless-runtime/blob/main/apps/demo/src/examples/accordion.ts).
