...
The modal, non-modal, nested, and no-tabbable examples use the production controller through the component-specific [`dialog.ts` example module](https://github.com/DanieleMasone/ui-headless-runtime/blob/main/apps/demo/src/examples/dialog.ts).
