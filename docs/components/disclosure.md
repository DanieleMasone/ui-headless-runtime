...
Uncontrolled, controlled, and disabled examples execute from the component-specific [`disclosure.ts` example module](https://github.com/DanieleMasone/ui-headless-runtime/blob/main/apps/demo/src/examples/disclosure.ts).
