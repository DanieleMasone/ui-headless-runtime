...
- The generated documentation site under `/docs/`, including the User Guide, framework integration recipes, component contracts, architecture pages, and release guidance.
...
- Axe checks for the demo shell, component examples in initial and active states, and representative generated documentation pages, including the React, Vue, and Angular recipes.
...
Review version: **2026-07-11**. Status values are `tested`, `not applicable`, `consumer responsibility`, and `pending`.
...
| Reflow and text spacing                 | 1.4.10, 1.4.12                        | `tested`                  | Critical demo and documentation routes, including framework recipes, are reviewed at 320 CSS pixels; long code and tables scroll within their own region. |
